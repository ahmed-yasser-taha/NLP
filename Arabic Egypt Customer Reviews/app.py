...
# Title and subtitle
title_label = tk.Label(main_frame, text="Sentiment Analysis Tool", font=('Arial', 36, 'bold'), bg='#1a1a1a', fg='#ffffff')
title_label.grid(row=0, column=0, columnspan=3, pady=(0, 20), sticky="ew")
subtitle_label = tk.Label(main_frame, text="Analyze Reviews with AI Precision", font=('Arial', 18, 'italic'), bg='#1a1a1a', fg='#7f8c8d')
subtitle_label.grid(row=1, column=0, columnspan=3, pady=(0, 20), sticky="ew")

# Upload button
upload_btn = tk.Button(main_frame, text="📤 Upload Excel", command=load_and_process, bg='#2ecc71', fg='white', font=('Arial', 16, 'bold'), padx=20, pady=10, relief='raised', bd=3)
...
predict_btn = tk.Button(input_frame, text="Predict", command=predict_manual, bg='#3498db', fg='white', font=('Arial', 16, 'bold'), padx=20, pady=10, relief='raised', bd=3)
...
tree_frame = tk.Frame(main_frame, bg='#1a1a1a')
tree_frame.grid(row=5, column=0, columnspan=3, pady=20, sticky="nsew")
...
style.configure("Custom.Treeview", background="#2c2c2c", foreground="#ffffff", fieldbackground="#2c2c2c")
for col in columns:
    tree.heading(col, text=col)
    tree.column(col, width=250, anchor='center', stretch=True)
...
# Footer
footer = tk.Label(main_frame, text="Powered by xAI <3", bg='#1a1a1a', fg='#7f8c8d', font=('Arial', 16, 'italic'))
